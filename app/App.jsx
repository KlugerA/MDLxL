...
export default function App() {
  ...
  const timeline = (<Suspense fallback={<div>Loading keyframes…</div>}><KeyframeTimeline
    ...
    onSelectKey={mode === 'animation' && animationPanel === 'movement' ? selectMotion : undefined}
    ...
    {inspectingMotion && motion.active && <Suspense fallback={null}><MotionInspector model={model} revision={doc.revision} sequenceIndex={sequence} globalSeqId={globalSeqId} time={time} selectedNodeIds={selectedNodeIds} mode={movementMode} motion={motion} anchor={motionAnchor} onClose={closeMotion} onSelect={selectMotion} onSeek={seekMotionTime} onReplay={replayMotion} onEdit={edit} onPlayingChange={setPlaying} disabled={doc.readOnly || saving} restrictions={restrictions} livePose={liveMotionPose}/></Suspense>}
