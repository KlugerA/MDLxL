...
export function uvPreviewOverlay(domain, selectionOrGeoset, selectedVertices, display, color = '#4cff59') {
  ...
  return {
    ...
    color:/^#[0-9a-f]{6}$/i.test(color)?color:'#4cff59', eligibleByGeoset:domain||{},selectionByGeoset,
  };
}
